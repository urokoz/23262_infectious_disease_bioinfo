...
vu_pipeline.py -b ${ANALYSIS_DIR} -f ${ANALYSIS_DIR}/input2.iso -g ${ANALYSIS_DIR}/part2_metadata.tsv -d ${DATABASE} -r ${KMA_DB} -t ${SIMILARITY} -o ${OUTPUT} -ml -pairwise -p ${THREADS} -ebi